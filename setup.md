# Environment & Prerequisites Setup Guide - SoilGuard-Portal

This guide details the system prerequisites required before installing SoilGuard-Portal on Windows or Linux.
